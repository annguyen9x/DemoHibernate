...
public class QuanLyKhachHang {
	...
	public static void main(String[] args) {
		...
		KhachHang khachHangUpdate = new KhachHang(maKhachHangUpdate, "123456", "Lê Bá Sửa " + maKhachHangUpdate, "lbsua" + maKhachHangUpdate + "@gmail.com", "0987654321");
		...
		if( isDelete == true ) {
			System.out.println("Xóa thành công, danh sách Khách Hàng sau Xóa :\n");
			List<KhachHang> khachHangsAfterUpdate = KhachHangDao.getListKhachHang();
			for( int i = 0; i < khachHangsAfterUpdate.size(); i++) {
				System.out.println(i + " : " + khachHangsAfterUpdate.get(i));
			}
